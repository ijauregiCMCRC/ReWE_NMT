...
def make_translator(opt, report_score=True, logger=None, out_file=None):
    ...
    translator = Translator(model, fields, global_scorer=scorer,
                            ...
                            copy_attn=model_opt.copy_attn, logger=logger,emb_decoding=opt.emb_decoding,
                            **kwargs)
    return translator
...
class Translator(object):
    ...
    def translate_batch(self, batch, data):
        ...
        beam = [onmt.translate.Beam(beam_size, n_best=self.n_best,
                                    ...
                                    dec_embeddings=self.model.decoder.embeddings.word_lut.weight.data,
                                    emb_decoding=self.emb_decoding)
        ...
        for i in range(self.max_length):
            ...
            if not self.copy_attn:
                if self.emb_decoding != True:
                    ...
                    out = self.model.generator_ReWE.forward(dec_out).data
                out = unbottle(out)
                # beam x tgt_vocab
