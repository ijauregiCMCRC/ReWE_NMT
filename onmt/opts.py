...
def model_opts(parser):
    ...
    group.add_argument('-ReWE', type=bool, default=False,
                       help='Use ReWE.')
    group.add_argument('-contrastive_B', action="store_true",
                       help='Use only ReWE, without NLL.')
    group.add_argument('-ReWE_loss', type=str, default="CEL",
                       help='Options:'
                            '1-> CEL: Cosine Embedding Loss'
                            '2-> MSE: Minimum Square Error'
                            '3-> max-margin: Max-margine cosine loss'
                            '4-> contrastive_A: ignore ReWE')
    group.add_argument('-lambda_loss', type=float, default=0.1,
                       help='Alpha to combine losses.')
...
def preprocess_opts(parser):
    ...
    group.add_argument('-train_src', default="",
                       help="Path to the training source data")
    group.add_argument('-train_tgt', default="",
                       help="Path to the training target data")
    group.add_argument('-valid_src', default="",
                       help="Path to the validation source data")
    group.add_argument('-valid_tgt', default="",
...
def translate_opts(parser):
    ...
    group.add_argument('-emb_decoding', action='store_true',
                       help="Decode using the predicted embeddings and nearest neighbour search")
