...
#TRAIN
tools/subword_BPE/subword-nmt/apply_bpe.py -c "data/eu-en_IT/BPE_EN_EU.${merge_ops}" < "data/eu-en_IT/train.eu.atok" > "data/eu-en_IT/train.eu.atok.bpe_${merge_ops}"
tools/subword_BPE/subword-nmt/apply_bpe.py -c "data/eu-en_IT/BPE_EN_EU.${merge_ops}" < "data/eu-en_IT/train.en.atok" > "data/eu-en_IT/train.en.atok.bpe_${merge_ops}"
#DEV
