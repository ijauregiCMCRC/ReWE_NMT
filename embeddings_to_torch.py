...
def main():
    ...
    parser.add_argument('-emb_file_enc', default='embeddings/fasttext.ro.vec', #required=True,
                        help="source Embeddings from this file")
    parser.add_argument('-emb_file_dec', default='embeddings/fasttext.en.vec', #required=True,
                        help="target Embeddings from this file")
    parser.add_argument('-output_file', default='WMT17/ro-en/embeddings/fasttext_UPDATED',#required=True,
                        help="Output file for the prepared data")
    parser.add_argument('-dict_file', default='WMT17/ro-en/BASELINE_UPDATED.TOKENIZED.100l.vocab.pt',#required=True,
